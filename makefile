...
SRC := $(SRC_DIR)/generalised_tic_tac_toe.cpp  $(SRC_DIR)/generalised_tic_tac_toe_bitboard.cpp $(SRC_DIR)/main.cpp $(SRC_DIR)/minimax.cpp $(SRC_DIR)/pn_search_unified.cpp $(SRC_DIR)/check_proof.cpp $(SRC_DIR)/monte_carlo_simulator.cpp
